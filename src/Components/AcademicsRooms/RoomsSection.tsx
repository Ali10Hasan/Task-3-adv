...
const CardData: CardDataInterface[] = [
    {
        images:[
            "/Task-3-adv/GroupImage1/Image.png",
            "/Task-3-adv/GroupImage1/Image (1).png",
            "/Task-3-adv/GroupImage1/Image (2).png",
            "/Task-3-adv/GroupImage1/Image (3).png",
            "/Task-3-adv/GroupImage1/Image (2).png",
            "/Task-3-adv/GroupImage1/Image (3).png",
            "/Task-3-adv/GroupImage1/Image (1).png",
        ],
    ...
    {
        images:[
            "/Task-3-adv/GroupImage2/Image.png",
            "/Task-3-adv/GroupImage2/Image (1).png",
            "/Task-3-adv/GroupImage2/Image (2).png",
            "/Task-3-adv/GroupImage2/Image (3).png",
            "/Task-3-adv/GroupImage2/Image (2).png",
            "/Task-3-adv/GroupImage2/Image (3).png",
            "/Task-3-adv/GroupImage2/Image (1).png",
        ],
    ...
    {
        images:[
            "/Task-3-adv/GroupImage3/Image.png",
            "/Task-3-adv/GroupImage3/Image (1).png",
            "/Task-3-adv/GroupImage3/Image (2).png",
            "/Task-3-adv/GroupImage3/Image (3).png",
            "/Task-3-adv/GroupImage3/Image (2).png",
            "/Task-3-adv/GroupImage3/Image (3).png",
            "/Task-3-adv/GroupImage3/Image (1).png",
    ...
    {
        images:[
            "/Task-3-adv/GroupImage4/Image.png",
            "/Task-3-adv/GroupImage4/Image (1).png",
            "/Task-3-adv/GroupImage4/Image (2).png",
            "/Task-3-adv/GroupImage4/Image (3).png",
            "/Task-3-adv/GroupImage4/Image (2).png",
            "/Task-3-adv/GroupImage4/Image (3).png",
            "/Task-3-adv/GroupImage4/Image (1).png",
            "/Task-3-adv/GroupImage4/Image (1).png",
    ...
    {
        images:[
            "/Task-3-adv/GroupImage5/Image.png",
            "/Task-3-adv/GroupImage5/Image (1).png",
            "/Task-3-adv/GroupImage5/Image (2).png",
            "/Task-3-adv/GroupImage5/Image (3).png",
            "/Task-3-adv/GroupImage5/Image (2).png",
            "/Task-3-adv/GroupImage5/Image (3).png",
            "/Task-3-adv/GroupImage5/Image (1).png",
        ],

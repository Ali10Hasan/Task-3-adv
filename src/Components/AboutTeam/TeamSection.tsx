...
const OurTeamData=[
    {
        image:"/Task-3-adv/member1.png",
        name:"Ms. Sarah Anderson",
        icone:"/Task-3-adv/TeamIcon.png",
        textContent:[
